export const Icons = {
  groups: {
    ...
    // CAMBIO: fill-orange-400 -> fill-red-600
    class: "mt-1 h-8 w-8 shrink-0 fill-red-600 dark:fill-red-500",
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    // CAMBIO: fill-orange-400 -> fill-red-600 (Para la pestaña activa)
    class:
      "mt-2 h-6 w-6 shrink-0 fill-neutral-700 hs-tab-active:fill-red-600 dark:fill-neutral-300 dark:hs-tab-active:fill-red-500 md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
  ...
  house: {
    ...
    // CAMBIO: text-orange-400 -> text-red-600 (Para la pestaña activa)
    class:
      "h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text-red-600 dark:text-neutral-300 dark:hs-tab-active:text-red-500 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  arrowUp: {
    ...
    // CAMBIO: text-orange-400 -> text-red-600
    class: "h-5 w-5 shrink-0 text-red-600 dark:text-red-500",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    paths: [
      {
        ...
        // CAMBIO: text-red-400 -> text-red-600 (Para consistencia exacta)
        class:
          "fill-current text-neutral-500 transition duration-300 group-hover:text-red-600 dark:group-hover:text-red-500",
      },
    ],
